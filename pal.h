...
extern void ringcolor();
extern void fade(int level, bool blackall, bool fromblack, bool total);
extern void lighting(int funct, int dir);
extern void dryuplake();
extern void rehydratelake();
