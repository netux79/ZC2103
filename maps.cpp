...
void draw_screen(mapscr* layer1, mapscr* layer2, int x1, int y1, int x2, int y2) {
	...
	if (draw_screen_clip_rect_x1 > 0 || draw_screen_clip_rect_y1 > 0 || draw_screen_clip_rect_x2 < 255 || draw_screen_clip_rect_y2 < 223) {
		...
		if (draw_screen_clip_rect_x1) {
			blit(scrollbuf, framebuf, 0,                          0,                          0,                          0,                          draw_screen_clip_rect_x1,                            224);
		}
		if (draw_screen_clip_rect_x2 < 255) {
			blit(scrollbuf, framebuf, draw_screen_clip_rect_x2 + 1, 0,                          draw_screen_clip_rect_x2 + 1, 0,                          255 - draw_screen_clip_rect_x2,                        224);
		}
		if (draw_screen_clip_rect_y1) {
			blit(scrollbuf, framebuf, draw_screen_clip_rect_x1,   0,                          draw_screen_clip_rect_x1,   0,                          draw_screen_clip_rect_x2 - draw_screen_clip_rect_x1 + 1, draw_screen_clip_rect_y1);
		}
		if (draw_screen_clip_rect_y2 < 223) {
			blit(scrollbuf, framebuf, draw_screen_clip_rect_x1,   draw_screen_clip_rect_y2 + 1, draw_screen_clip_rect_x1,   draw_screen_clip_rect_y2 + 1, draw_screen_clip_rect_x2 - draw_screen_clip_rect_x1 + 1, 223 - draw_screen_clip_rect_y1);
		}
	}
